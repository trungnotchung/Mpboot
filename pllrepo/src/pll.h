...
#define PLL_NUM_BRANCHES                        1 // Diep
#define PLL_TRUE                                1
#define PLL_FALSE                               0
...
typedef unsigned short parsimonyNumberShort;
...
typedef struct {
  ...
  int numInformativePatterns; /* Diep added - for UFBoot */
	...
	// This array is necessary in case the pll alignment is not sorted decreasingly by score
	//		i.e. uninformative sites are mixed with informative sites
	parsimonyNumber * informativePtnWgt;
