...
enum ConsensusType
{
        CT_NONE,
        CT_CONSENSUS_TREE,
        CT_CONSENSUS_NETWORK,
        CT_ASSIGN_SUPPORT,
        CT_ASSIGN_SUPPORT_EXTENDED,
        COMPARE
};
...
enum STOP_CONDITION
{
        SC_FIXED_ITERATION,
        SC_WEIBULL,
        SC_UNSUCCESS_ITERATION,
        SC_BOOTSTRAP_CORRELATION,
        SC_REAL_TIME
};
...
struct Params
{
        ...
        */
        ...
        /**
         * Alignment zip file name
         */
        char *alignment_zip_file;
